  ...
  const GHLMenuEditor = {
    ...
    initializeAllSelect2: function () {
      ...
      $(".ghl-tags-select").each(function () {
        ...
        var allTags =
          typeof ghlMenuEditor !== "undefined" && ghlMenuEditor.tags
            ? ghlMenuEditor.tags
            : [];
        ...
        $tagSelect.select2({
          ...
          tokenSeparators: [","],
          placeholder:
            typeof ghlMenuEditor !== "undefined" && ghlMenuEditor.strings
              ? ghlMenuEditor.strings.searchTags
              : "Search tags...",
          allowClear: true,
          width: "100%",
    ...
    updateTagFieldVisibility: function ($menuItem) {
      ...
      const showTags = ["has_any_tag", "has_all_tags", "not_has_tags"].includes(
        rule,
      );
