/**
 * LearnDash Course Meta Box tag selectors
 */
(function($) {
	'use strict';
	...
	$(document).ready(function() {
		...
		initializeSelect($('#ghl_ld_auto_enroll_tag'));
		initializeSelect($('#ghl_ld_completed_tags'));
	});
	...
	function initializeSelect($select) {
		...
		const context = $select.data('context') || 'auto';
	...
	function getPlaceholder(context) {
		if (context === 'completion' && ghlLearnDashMetaBox.i18n.completePlaceholder) {
			return ghlLearnDashMetaBox.i18n.completePlaceholder;
		}

		return ghlLearnDashMetaBox.i18n.autoPlaceholder;
	}
})(jQuery);
