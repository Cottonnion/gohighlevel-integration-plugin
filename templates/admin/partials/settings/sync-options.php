...
<div class="ghl-settings-wrapper">
	...
	<div class="ghl-settings-section ghl-settings-card">
		<div class="ghl-settings-header">
			<h2>
				...
				<?php esc_html_e( 'Note Synchronization', 'syncly' ); ?>
			</h2>
			<p class="description">
				<?php esc_html_e( 'Automatically sync notes and comments between WordPress and GoHighLevel contact notes', 'syncly' ); ?>
			</p>
		</div>
				...
				<div class="ghl-form-item">
					<div class="ghl-form-item-content ghl-form-item-content--column">
						<label for="note_sync_direction" class="ghl-form-label">
							<?php esc_html_e( 'Sync Direction', 'syncly' ); ?>
							<span class="ghl-tooltip-icon" data-ghl-tooltip="<?php esc_attr_e( 'Choose how notes should sync between WordPress and GoHighLevel. Select the direction that matches your workflow.', 'syncly' ); ?>">?</span>
						</label>
						<select 
	...
	<button type="button" id="save-sync-options" class="ghl-button ghl-button-primary ghl-save-settings-btn">
		<span class="ghl-button-text"><?php esc_html_e( 'Save Sync Options', 'syncly' ); ?></span>
	</button>
